var steps = [
    {
        ...
        "render": () => {
            textAndInteraction(
                ...
                () => {
                    var p = createGMapsButton("anzahl_beschaeftigte", "Google Maps please!").then( (result) => {
...
function createGMapsButton(jumpOnConfirm, text = 'Ort auswählen',addAutoText=true)
{
    return botui.action.gmaps({
        addMessage: addAutoText,
        action: [
            {
                icon: 'check',
