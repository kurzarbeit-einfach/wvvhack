...
<div class="container hero">
    ...
    <div class="bottom">
            <div class="wirvsvirus"></div>

        <button class="next" data-target="info">Los geht's!</button>
    </div>
</div>
...
<div class="container info">
    <div class="inner">
        ...
        <div class="innerBottom">
            <button class="next" data-target="info2">Weiter zu: Voraussetzungen</button>
        </div>
    </div>
</div>
...
<div class="container info5">
    <div class="inner">
        ...
        <p>
                ...
                <br><br>
                <span class="stepLabel">Schritt 3</span><br/>
...
<div class="container thanks">
    <div class="inner">
        <h2>Geschafft! Die letzten Schritte:</h2>
        <p>
            Das wäre geschafft, auf Basis deiner Antworten habe ich für dich das Formular zur Anzeige der Kurzarbeit für die Agentur für Arbeit komplett ausgefüllt!
        </p>
        <p>
            <button class="download">Formular herunterladen (PDF)</button>
        </p>

        <ol>
            <li>
                Lade deine PDF herunter und unterschreibe das Formular
            </li>
            <li>
                Registriere dich unter arbeitsagentur.de
            </li>
            <li>
                Lade deine PDF auf der dafür vorgesehen Seite hoch! Voilá
            </li>
        </ol>

        <p>
            Vielen Dank, dass du unsere Hilfe genutzt hast. Falls du weitere Ideen zur Verbesserung dieses Angebots hast, dann freuen wir uns riesig, wenn du uns unter hallo@kurzarbeit-einfach.de schreibst.
        </p>
